...
describe Prometheus::Client::DataStores::CentralHashExample do
  ...
  it "does not accept Metric Settings" do
    ...
    end.to raise_error(Prometheus::Client::DataStores::CentralHashExample::InvalidStoreSettingsError)
  end
end
